...
var debug   = require('debug')('express-combo:static'),
    ...
    strategy = require('yui-pathogen-decoder'),
    yuicombo = require('yui-combo-middleware'),
    decoder = yuicombo.createComposite(
        // decode custom combo urls into module names
    ...
    **/
    combine: function (config) {
        ...
        return function (req, res, next) {
            ...
            // If the request is a custom combo url, redirect to self using a
            // relative-path-based combo url.
